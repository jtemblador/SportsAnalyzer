...
def test_week_offset_fix():
    ...
    v1_model_dir = project_root / "data/nfl/models/v1_baseline_mae5.14"
    ...
    try:
        ...
        pred_file = project_root / "data/nfl/predictions/v1_baseline_mae5.14/predictions_2025_week_10.parquet"
        if pred_file.exists():
